...
getCursoAsignatura = () ->
  jsRoutes.controllers.Preguntas.getFiltros($("#idTipoPregunta option:selected").val()).ajax myAjax
...
getCategorias = () ->
  ...
  unless idAsignatura and idCurso and idTipo
    ...
    jsRoutes.controllers.Preguntas.getJerarquia(idTipo,idAsignatura,idCurso).ajax ctgrsAjax
